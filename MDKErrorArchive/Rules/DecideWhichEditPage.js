export default function DecideWhichEditPage(context) {
  ...
  switch (affectedEntityType) {
    case "PurchaseOrderHeaders":
        targetAction = "/MDKErrorArchive/Actions/PurchaseOrderHeaders/NavToPurchaseOrderHeaders_Edit.action";
      break;
    default:
        ...
        return context.executeAction("/MDKErrorArchive/Actions/UnknownAffectedEntityMessage.action");
  }
